				...
				<div class="MessageContainer">
					...
					<div class="Message">
						...
						<table style="width:100%;">
							...
							<nobr>[<a href="#quantosplayers">Quantos jogadores são indicados para conseguir conquistar o Castelo?</a>]</nobr> 
...
<div class="TableContainer">
		...
		<tbody>
		<tr><td>
		O CastleSiege é automático e acontecerá todos os dias das<b> 20:00 às 21:00</b>, quando for o horário um teleport surgirá no <b>Templo de Blood City</b> e todos serão avisados minutos antes do castelo ficar aberto para invasão/batalha.
...
<div class="TopButtonContainer">
		...
		<tbody>
		<tr><td>
		Os jogadores entram no teleport, e vão pelo caminho para chegar a alavanca que conquista o castelo, até chegar na mesma, aparecem Protetores, criaturas super fortes que farão de tudo para os matar,
		sendo assim deve-se ir com uma boa guild, a guild que permanecer por mais tempo no controle da alavanca, ganhará o Castelo, e terá acesso exclusivo a hunts ótimas, até no dia seguinte no mesmo horário.
		</td></tr>
		</tbody></table></td>
		  </tr></tbody></table>  </div></div><div class="TableShadowContainer"> 
		<div class="TableBottomShadow" style="background-image:url(./layouts/tibiarl/images/content/table-shadow-bm.gif);">   
...
<div class="TableContainer">
					<div class="CaptionContainer">
							<div class="CaptionInnerContainer"> 
								...
								<span class="CaptionBorderTop" style="background-image:url(./layouts/tibiarl/images/content/table-headline-border.gif);"></span> 
								<span class="CaptionVerticalLeft" style="background-image:url(./layouts/tibiarl/images/content/box-frame-vertical.gif);"></span>							
								<div class="Text">Quantos jogadores são indicados para conseguir conquistar o Castelo?</div>
								<span class="CaptionVerticalRight" style="background-image:url(./layouts/tibiarl/images/content/box-frame-vertical.gif);"></span>
								<span class="CaptionBorderBottom" style="background-image:url(./layouts/tibiarl/images/content/table-headline-border.gif);"></span> 
								<span class="CaptionEdgeLeftBottom" style="background-image:url(./layouts/tibiarl/images/content/box-frame-edge.gif);"></span>
								<span class="CaptionEdgeRightBottom" style="background-image:url(./layouts/tibiarl/images/content/box-frame-edge.gif);"></span>
		...
		<tbody>
		<tr><td>
		Pelo menos 5 jogadores por guild
		</td></tr>
		</tbody></table></td>
		  </tr></tbody></table>  </div></div><div class="TableShadowContainer"> 
		<div class="TableBottomShadow" style="background-image:url(./layouts/tibiarl/images/content/table-shadow-bm.gif);">   
...
<div class="TableContainer">
			...
			<td width="15%" align="left" class="white"><b>Nome</b></td>
			<td width="50%" align="center" class="white"><b>Descrição</b></td>
			</tr>
			<tr bgcolor="#F1E0C6">
                  <td><center><b>Caves Exclusivas</b></center></td>
                  <td><div align="center"><b>(10 caves enormes, com exp/loot ótimos).</b><br>
				  <i>(Uma boa caçada por 24 horas!!).</i></div></td></tr>
