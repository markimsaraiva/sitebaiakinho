...
$news_content .= '
    <div id="FeaturedArticle" class="Box">
				 ...
				 </b></font></center><br></b><font size="2px"> <center> <b> IP: </b> logan-global.net</font> - <b>Port: </b> 7171 - <b> Client: </b> 10.00 | 11.46 </center> <center> <a href="http://www.mediafire.com/file/si72dlhk03dkedd/Cliente+11.rar">Download Client</a> </center>
				 <pre>
    ...
    if(isset($last_threads[0]))
    {
        foreach($last_threads as $thread)
        {
            $main_content .= '
				...
				<tr>';
            $main_content .= '
				<td style=\'padding-left:10px;padding-right:10px;\' >' . showPost('', $thread['post_text'], $thread['post_smile']) . '<p align="right"><a href="https://www.facebook.com/loganglobal/">->Veja em nossa Pagina.</a></p></td>';
