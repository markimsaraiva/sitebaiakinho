    ...
    <div class="TableContainer">
      <div class="CaptionContainer">
          <div class="CaptionInnerContainer">
            ...
            <div class="Text">Download Client to play now.</div>
                              ...
                              <table class="TableContent" width="100%">
                                <tbody><tr>
                                  <td><table style="width:100%;text-align:center">
                                      <tbody><tr>
                                        <td><a target="_blank" type="application/octet-stream"><img style="width:180px;height:180px;border:0px" src="./layouts/tibiacom/images/account/download_windows.png"></a></td>
                                        <td><a target="_blank" type="application/octet-stream"><img style="width:180px;height:180px;border:0px" src="./layouts/tibiacom/images/account/download_linux.png"><br>
                                          </a></td>
                                      </tr>
                                      <tr>
                                        <td valign="top"><a href="otserv.exe" target="_blank" type="application/octet-stream"><img src="./layouts/tibiacom/images/download.png"> Opcao 1 - Cliente 1146</a><p><a href="http://www.mediafire.com/file/fq0eadaexsn4bhs/otserv.exe" target="_blank" type="application/octet-stream"><img src="./layouts/tibiacom/images/download.png"> Opcao 2 - Cliente 1000</a><p><a href="logan.rar" target="_blank" type="application/octet-stream"><img src="./layouts/tibiacom/images/download.png"> Opcao 3 - Portable</a>
                                        <td valign="top"><a href="MagebotSetupvT10000.exe" target="_blank" type="application/octet-stream"><img src="./layouts/tibiacom/images/download.png"> Opcao 1 - Download</a><p><a href="http://www.mediafire.com/file/fcpgyhhtfhi8n1g/MagebotSetup10000.exe" target="_blank" type="application/octet-stream"><img src="./layouts/tibiacom/images/download.png"> Opcao 2 - Mediafire</a>
                                      </tr>
                                    </tbody></table>
                                  </td>
                                </tr>
                        ...
                        <td style="vertical-align:top"><div class="TableShadowContainerRightTop">
                          ...
                          <div class="TableContentAndRightShadow" style="background-image:url(./layouts/tibiacom/images/global/content/table-shadow-rm.gif)">
                            <div class="TableContentContainer">
                              <table class="TableContent" width="100%">
                                <tbody><tr>
                                  <td style="text-align:center"><img style="width:254px;height:218px;margin:7px" src="./layouts/tibiacom/images/account/successful_download.jpg"></td>
                                </tr>
                              </tbody></table>
                            </div>
                          </div>
