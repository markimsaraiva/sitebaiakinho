...
<tbody>
	<tr>
		<td class="white" colspan="3" bgcolor="#505050"><span class="style4">Informações Capture The Flag</span></td>
	</tr>
	<tr>
...
<br><b>OBS³:</b>
Não é permitido usar nenhum tipo de magia para ficar invisivel ou stealth ring. </span></td>
	</tr>
		<td colspan="3" bgcolor="#d4c0a1"><span class="style4"><center><img src="ctf.png"></center></span>
		</td>
	</tr>
	...
	<tr>
  		<td colspan="3" bgcolor="#f1e0c6">
			<span class="style4">
				<i>Todos os dias as 18:00 e 20:00.
			</span>
		</td>
	</tr>
	...
	<tr>
  		<td colspan="3" bgcolor="#f1e0c6">
			<span class="style4">
				<i><img src="19event.png"><br>Cada jogador do time vencedor 80 Event Coins e + <font color="green"><b>35000000</b></font> de expêriencia.
			</span>
		</td>
	</tr>
	<tr>
...
<tr>
	...
	<tr>
  		<td colspan="3" bgcolor="#f1e0c6">
			<span class="style4">
				<i><img src="18event.png"><br>Todos os jogadores ganharam 50 Event Coin + <font color="green"><b>20000000</b></font> de expêriencia.
			</span>
		</td>
	</tr>
	<tr>
												...
												<td>
													...
													<div class="TableContentAndRightShadow" style="background-image:url(./layouts/tibiarl/images/global/content/table-shadow-rm.gif);" >
														<div class="TableContentContainer" >
															<table class="TableContent" width="100%"  style="border:1px solid #faf0d7;" >
																<tr>
																	<td width="50%"><b>Valor: 140 Event Coin Coins</b></br><img src="7event.png"></td><td width="50%"><b>Double Exp</b></br><img src="6event.png"></td>
																</tr>									
															</table>
														</div>
													</div>											
												...
												<td>
													...
													<div class="TableContentAndRightShadow" style="background-image:url(./layouts/tibiarl/images/global/content/table-shadow-rm.gif);" >
														<div class="TableContentContainer" >
															<table class="TableContent" width="100%"  style="border:1px solid #faf0d7;" >
																<tr>
																	<td><b>1 Cave Exclusiva</b><b></b> com hunts exclusivas por 6 horas.</td>																</tr>									
															</table>
														</div>
													</div>											
													<div class="TableShadowContainer" >
												...
												<td>
													...
													<div class="TableContentAndRightShadow" style="background-image:url(./layouts/tibiarl/images/global/content/table-shadow-rm.gif);" >
														<div class="TableContentContainer" >
															<table class="TableContent" width="100%"  style="border:1px solid #faf0d7;" >
																<tr>
																	<td width="50%"><b>Valor: 250 Event Coins</b></br><img src="8event.png"></td><td width="50%"><b>Cave Exclusiva</b></br><img src="9event.png"></td>
																</tr>									
															</table>
														</div>
													</div>											
												...
												<td>
													...
													<div class="TableContentAndRightShadow" style="background-image:url(./layouts/tibiarl/images/global/content/table-shadow-rm.gif);" >
														<div class="TableContentContainer" >
															<table class="TableContent" width="100%"  style="border:1px solid #faf0d7;" >
																<tr>
																	<td width="50%"><b>Valor: 50 Event Coins</b></br><img src="10event.png"></td><td width="50%"><b>Double Exp 15 min</b></br><img src="11event.png"></td>
																</tr>									
															</table>
														</div>
													</div>											
												...
												<td>
													...
													<div class="TableContentAndRightShadow" style="background-image:url(./layouts/tibiarl/images/global/content/table-shadow-rm.gif);" >
														<div class="TableContentContainer" >
															<table class="TableContent" width="100%"  style="border:1px solid #faf0d7;" >
																<tr>
																	<td width="50%"><b>Valor: 80 Event Coins</b></br><img src="15event.png"></td><td width="50%"><b>Critical Stone</b></br><img src="13event.png"></td>
																</tr>									
															</table>
														</div>
													</div>											
												...
												<td>
													...
													<div class="TableContentAndRightShadow" style="background-image:url(./layouts/tibiarl/images/global/content/table-shadow-rm.gif);" >
														<div class="TableContentContainer" >
															<table class="TableContent" width="100%"  style="border:1px solid #faf0d7;" >
																<tr>
																	<td width="50%"><b>Valor: 60 Event Coin</b></br><img src="12event.png"></td><td width="50%"><b>Dodge Stone</b></br><img src="14event.png"></td>
																</tr>									
															</table>
														</div>
													</div>											
												...
												<td>
													...
													<div class="TableContentAndRightShadow" style="background-image:url(./layouts/tibiarl/images/global/content/table-shadow-rm.gif);" >
														<div class="TableContentContainer" >
															<table class="TableContent" width="100%"  style="border:1px solid #faf0d7;" >
																<tr>
																	<td width="50%"><b>Valor: 50 Event Coins</b></br><img src="17event.png"></td><td width="50%"><b>Stamina Potion</b></br><img src="16event.png"></td>
													</tr>									
															</table>
														</div>
													</div>											
