				...
				<div class="MessageContainer">
					...
					<div class="Message">
						...
						<table style="width:100%;">
							...
							<nobr>[<a href="#quantosplayers">Quantos jogadores são necessários para iniciar o evento?</a>]</nobr> 
							<nobr>[<a href="#premios">Quais são os premios?</a>]</nobr>			
							</td>
						</tr>
					</tbody></table>
				</div>
...
<div class="TableContainer">
		...
		<tbody>
		<tr><td>
		O Zombie Event é automático e acontecerá todos os dias em três horarios: <b>10:00, 13:00 e 23:00</b>, quando for o horário um teleport surgirá no <b>Templo de Blood City</b> e uma mensagem aparecerá para todos online.
...
<div class="TopButtonContainer">
		...
		<tbody>
		<tr><td>
		Os jogadores entram no teleport do templo, e são lançados para a arena do Evento, 3 minutos após iniciar o evento, a sala sera liberada e a cada 3 segundos aparecerá um novo zombie aleatoriamente na area, seu objetivo é evitar ser pego por um zumbi, se isto acontecer você vai ser expulso do evento, o último jogador a sobreviver será o vencedor.
		<br><small><b>Caso você morra <span style="color:red;">não perderá level, skills e nem itens</span> no evento.</b></small>
		</td></tr>
		</tbody></table></td>
		  </tr></tbody></table>  </div></div><div class="TableShadowContainer"> 
		<div class="TableBottomShadow" style="background-image:url(./layouts/tibiarl/images/content/table-shadow-bm.gif);">   
		...
		<tbody>
		<tr><td>
		<b>OBS¹:</b> <i>Você pode matar os zombies com avalanche rune, mas outro aparecera aleatoriamente em seu lugar.</i><br>
		</td></tr>
		</tbody></table></td>
		  </tr></tbody></table>  </div></div><div class="TableShadowContainer"> 
		<div class="TableBottomShadow" style="background-image:url(./layouts/tibiarl/images/content/table-shadow-bm.gif);">   
		...
		<tbody>
		<tr><td>
		<b>OBS²:</b> <i>Lembrando que o uso de <b>Magic Wall rune</b> e <b>Wild Growth rune</b> é bloqueado no local do evento.</i>
		</td></tr>
		</tbody></table></td>
		  </tr></tbody></table>  </div></div><div class="TableShadowContainer"> 
		<div class="TableBottomShadow" style="background-image:url(./layouts/tibiarl/images/content/table-shadow-bm.gif);">   
		...
		<tbody>
		<tr><td>
		<b>OBS³:</b><i> Summons são deletadas automaticamente do evento.</i>
		</td></tr>
		</tbody></table></td>
		  </tr></tbody></table>  </div></div><div class="TableShadowContainer"> 
		<div class="TableBottomShadow" style="background-image:url(./layouts/tibiarl/images/content/table-shadow-bm.gif);">   
...
<div class="TableContainer">
					<div class="CaptionContainer">
							<div class="CaptionInnerContainer"> 
								...
								<span class="CaptionBorderTop" style="background-image:url(./layouts/tibiarl/images/content/table-headline-border.gif);"></span> 
								<span class="CaptionVerticalLeft" style="background-image:url(./layouts/tibiarl/images/content/box-frame-vertical.gif);"></span>							
								<div class="Text">Quantos jogadores são necessários para iniciar o evento?</div>
								<span class="CaptionVerticalRight" style="background-image:url(./layouts/tibiarl/images/content/box-frame-vertical.gif);"></span>
								<span class="CaptionBorderBottom" style="background-image:url(./layouts/tibiarl/images/content/table-headline-border.gif);"></span> 
								<span class="CaptionEdgeLeftBottom" style="background-image:url(./layouts/tibiarl/images/content/box-frame-edge.gif);"></span>
								<span class="CaptionEdgeRightBottom" style="background-image:url(./layouts/tibiarl/images/content/box-frame-edge.gif);"></span>
...
<div class="TableContainer">
					<div class="CaptionContainer">
							<div class="CaptionInnerContainer"> 
								...
								<span class="CaptionBorderTop" style="background-image:url(./layouts/tibiarl/images/content/table-headline-border.gif);"></span> 
								<span class="CaptionVerticalLeft" style="background-image:url(./layouts/tibiarl/images/content/box-frame-vertical.gif);"></span>							
								<div class="Text">Quais são os premios?</div>
								<span class="CaptionVerticalRight" style="background-image:url(./layouts/tibiarl/images/content/box-frame-vertical.gif);"></span>
								<span class="CaptionBorderBottom" style="background-image:url(./layouts/tibiarl/images/content/table-headline-border.gif);"></span> 
								<span class="CaptionEdgeLeftBottom" style="background-image:url(./layouts/tibiarl/images/content/box-frame-edge.gif);"></span>
								<span class="CaptionEdgeRightBottom" style="background-image:url(./layouts/tibiarl/images/content/box-frame-edge.gif);"></span>
			...
			<td width="50%" align="center" class="white"><b>Descrição</b></td>
			</tr>
			<tr bgcolor="#F1E0C6">
			<td><div align="center"><img src="http://vignette3.wikia.nocookie.net/tibia/images/5/55/Crystal_Coin.gif/revision/latest?cb=20050621223350&path-prefix=en" width="50" height="50"></div></td>
                  ...
                  <td><div align="center"><b>100 Crystal Coins para o time vencedor.</b><br></div></td></tr>
