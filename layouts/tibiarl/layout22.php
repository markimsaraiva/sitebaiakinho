...
<audio controls="">
&nbsp;&nbsp;&nbsp;&nbsp;<source src="Diogo Teixeira - BaiakNew.mp3" type="audio/mp3">
</audio>
  ...
  fjs.parentNode.insertBefore(js, fjs);
							...
							<a href="?subtopic=archive">
								...
								<a href="?subtopic=tradeoff">
  								<div id="submenu_cast" class="Submenuitem" onmouseover="MouseOverSubmenuItem(this)" onmouseout="MouseOutSubmenuItem(this)">
									...
									<div id="ActiveSubmenuItemLabel_tradeoff" class="SubmenuitemLabel"><span style="color:white;text-shadow: #9400D3 1px 1px 10px;"><img src="" alt=""><span style="background: transparent url(/layouts/tibiarl/images/menu/bg_menu.gif)">Trade OFF</span></span></div>
									<div class="RightChain" style="background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);"></div>
  								</div>
			...
			<a href="?subtopic=warofemperium">
					<div id="submenu_warofemperium" class="Submenuitem" onmouseover="MouseOverSubmenuItem(this)" onmouseout="MouseOutSubmenuItem(this)">
						...
						<div id="ActiveSubmenuItemLabel_warfoemperium" class="SubmenuitemLabel"><span style="color:white;text-shadow: #3ea7fa 1px 1px 10px;"><img src="" alt=""><span style="background: transparent url(/layouts/tibiarl/images/menu/bg_menu.gif)">War Of Emperium </div>
						<div class="RightChain" style="background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);"></div>
					</div>
				</a>
			...
			<a href="?subtopic=castle24hr">
					<div id="submenu_castle24hr" class="Submenuitem" onmouseover="MouseOverSubmenuItem(this)" onmouseout="MouseOutSubmenuItem(this)">
						...
						<div id="ActiveSubmenuItemLabel_castle24hr" class="SubmenuitemLabel"><span style="color:white;text-shadow: #3ea7fa 1px 1px 10px;"><img src="" alt=""><span style="background: transparent url(/layouts/tibiarl/images/menu/bg_menu.gif)">Castle 24H </div>
						<div class="RightChain" style="background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);"></div>
					</div>
				</a>
			...
			<a href="?subtopic=sellpoints">
          		...
          		<a href="?subtopic=battlefield">
					<div id="submenu_battlefield" class="Submenuitem" onmouseover="MouseOverSubmenuItem(this)" onmouseout="MouseOutSubmenuItem(this)">
						...
						<div id="ActiveSubmenuItemLabel_battlefield" class="SubmenuitemLabel"><span style="color:white;text-shadow: #3ea7fa 1px 1px 10px;"><img src="" alt=""><span style="background: transparent url(/layouts/tibiarl/images/menu/bg_menu.gif)">BattleField </div>
						<div class="RightChain" style="background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);"></div>
					</div>
				</a>
			<a href="?subtopic=bandeira">
					<div id="submenu_bandeira" class="Submenuitem" onmouseover="MouseOverSubmenuItem(this)" onmouseout="MouseOutSubmenuItem(this)">
						...
						<div id="ActiveSubmenuItemLabel_bandeira" class="SubmenuitemLabel"><span style="color:white;text-shadow: #3ea7fa 1px 1px 10px;"><img src="" alt=""><span style="background: transparent url(/layouts/tibiarl/images/menu/bg_menu.gif)">Capture The Flag </div>
						<div class="RightChain" style="background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);"></div>
					</div>
				</a>
