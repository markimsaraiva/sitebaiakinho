...
document.oncontextmenu = new Function("return false;")
  ...
  <title>Logan-Global - Free Multiplayer Online Role Playing Game</title>
...
<div id="MenuColumn">
<div id="LeftArtwork">
<img src="<?PHP echo $layout_name; ?>/images/header/tibia-logo-artwork-top.gif" alt="logoartwork" name="TibiaLogoArtworkTop" id="TibiaLogoArtworkTop" onClick="window.location = '?subtopic=latestnews';" />
</div>
<div id="Loginbox" >
...
<a href='?subtopic=buypoints'>
  <div id='submenu_buypoints' class='Submenuitem' onMouseOver='MouseOverSubmenuItem(this)' onMouseOut='MouseOutSubmenuItem(this)'>
    ...
    <div class='SubmenuitemLabel'<span style="color: #ffff00;">Donate! </div>
    <div class='RightChain' style='background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);'></div>
  </div>
</a>
</div>
...
<a href='?subtopic=changename'>
  <div id='submenu_changename' class='Submenuitem' onMouseOver='MouseOverSubmenuItem(this)' onMouseOut='MouseOutSubmenuItem(this)'>
    <div class='LeftChain' style='background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);'></div>
    <div id='ActiveSubmenuItemIcon_changename' class='ActiveSubmenuItemIcon' style='background-image:url(<?PHP echo $layout_name; ?>/images/menu/icon-activesubmenu.gif);'></div>
    <div class='SubmenuitemLabel'>Change Name</div>
    <div class='RightChain' style='background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);'></div>
...
<div id="Footer">
All rights reserveds CipSoft 2017 - Logan-Global 10.00 / 11.46
</div>
</div>
...
<div id="VideoBox" class="Themebox" style="background-image:url(./layouts/tibiacom/images/header/trailerbox-header.gif); onMouseOver="$('#TrailerOverFrame').css('visibility', 'visible');" onMouseOut="$('#TrailerOverFrame').css('visibility', 'hidden');" onClick="$('#LightBox').toggle();"">
											<div id="VideoBlock" >
												<iframe style="border: 2px solid grey;" width="165" height="82" src="https://www.youtube.com/embed/11DSoJbOYJU" frameborder="0" allowfullscreen></iframe>
											</div>
											<div class="Bottom" style="background-image:url(<?PHP echo "$layout_name"; ?>/images/general/box-bottom.gif);"></div>
										</div>
										<!-- serverinfo box -->
...
<div id="NetworksBox" class="Themebox"  style="background-image:url(<?PHP echo "$layout_name"; ?>/images/themeboxes/networksbox.png);" >
  <div id="FacebookBlock" >
    <div id="FacebookLikeBox" >
      <div class="fb-like-box" data-href="https://www.facebook.com/seu-Global-1266956380025404/?ref=br_rs/" data-width="175" data-height="200" data-show-faces="true" data-stream="false" data-border-color="none" data-header="false"></div>
    </div>
    <div id="FacebookSendBox" >
      <div class="fb-send" data-href="https://www.facebook.com/seu-Global-1266956380025404/?ref=br_rs/" data-width="50" data-height="20" ></div>
    </div>
    <div id="FacebookLikes" >
      <div class="fb-like" data-href="https://www.facebook.com/seu-Global-1266956380025404/?ref=br_rs/" data-width="50" data-layout="standard" data-show-faces="false" ></div>
    </div>
  </div>
  <div id="TwitterBlock" >
