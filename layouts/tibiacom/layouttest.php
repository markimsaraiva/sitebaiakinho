...
<head>
<!-- Hotjar Tracking Code for logan-global.com -->
<script>
...
<!-- Start of logan Zendesk Widget script -->
<script>/*<![CDATA[*/window.zEmbed||function(e,t){var n,o,d,i,s,a=[],r=document.createElement("iframe");window.zEmbed=function(){a.push(arguments)},window.zE=window.zE||window.zEmbed,r.src="javascript:false",r.title="",r.role="presentation",(r.frameElement||r).style.cssText="display: none",d=document.getElementsByTagName("script"),d=d[d.length-1],d.parentNode.insertBefore(r,d),i=r.contentWindow,s=i.document;try{o=s}catch(e){n=document.domain,r.src='javascript:var d=document.open();d.domain="'+n+'";void(0);',o=s}o.open()._l=function(){var e=this.createElement("script");n&&(this.domain=n),e.id="js-iframe-async",e.src="https://assets.zendesk.com/embeddable_framework/main.js",this.t=+new Date,this.zendeskHost="logan.zendesk.com",this.zEQueue=a,this.body.appendChild(e)},o.write('<body onload="document._l();">'),o.close()}();
/*]]>*/</script>
<!-- End of logan Zendesk Widget script -->
...
<div id="Footer">
Layout edited by <a href="#" target="_new"><b>Logan</b></a><br />
All rights reserveds Logan-Global 2017 / 10.00 - 11.00
</div>
</div>
...
$(document).ready(function() {
  ...
  var g_Now = Math.floor(new Date().getTime() / 1000);
  {
    ...
    var g_AnniversaryDate = new Date(2017, 14, 09, 19, 00, 00); // careful! January hat the number "0"
...
<div id="NetworksBox" class="Themebox"  style="background-image:url(<?PHP echo "$layout_name"; ?>/images/themeboxes/networksbox.png);" >
  <div id="FacebookBlock" >
    <div id="FacebookLikeBox" >
      <div class="fb-like-box" data-href="https://www.facebook.com/Loganglobal" data-width="175" data-height="200" data-show-faces="true" data-stream="false" data-border-color="none" data-header="false"></div>
    </div>
    <div id="FacebookSendBox" >
      <div class="fb-send" data-href="https://www.facebook.com/Loganglobal" data-width="50" data-height="20" ></div>
    </div>
    <div id="FacebookLikes" >
      <div class="fb-like" data-href="https://www.facebook.com/Loganglobal" data-width="50" data-layout="standard" data-show-faces="false" ></div>
    </div>
  </div>
  <div id="TwitterBlock" >
