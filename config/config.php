...
//Worlds
$config['site']['worlds'] = array(0 => 'Baiakciteron');
//Others
...
$config['site']['newaccount_premdays'] = 30; // how many days receive new account
...
$config['pagseguro']['email'] = 'scooby-danger@live.com';
